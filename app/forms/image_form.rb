class ImageForm
  ...
  self.terms = [:title, :accession_number, :alternative, :description, :series_name, :work_type, :form_of_work, :extent, :place_of_publication, :location, :lc_subject, :publisher, :creator, :contributor, :digital_origin, :sub_location, :use_restrictions]
