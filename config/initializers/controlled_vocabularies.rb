...
RDF_VOCABS = {
  ...
  :ldp                  =>  { prefix: 'http://www.w3.org/ns/ldp#', strict: false, fetch: false },
  # :getty_tgn            =>  { prefix: 'http://vocab.getty.edu/tgn/', strict: false, fetch: false },
  :cclicenses           =>  { prefix: 'http://creativecommons.org/licenses/' },
  :ccpublic             =>  { prefix: 'http://creativecommons.org/publicdomain/'},
  :rights               =>  { prefix: 'http://opaquenamespace.org/ns/rights/', strict: true },
  :eurights             =>  { prefix: 'http://www.europeana.eu/rights/', strict: true },
